...
namespace VentureHerdManager.Api.Migrations
{
    ...
    [Migration("20260723235708_AddCurrentLactationToAnimal")]
    partial class AddCurrentLactationToAnimal
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VentureHerdManager.Api.Models.AppearanceSetting", b =>
                {
                    ...
                    b.ToTable("AppearanceSettings", t =>
                        {
                            t.HasCheckConstraint("CK_AppearanceSettings_BackgroundOpacity", "[BackgroundOpacity] >= 0 AND [BackgroundOpacity] <= 1");

                            t.HasCheckConstraint("CK_AppearanceSettings_OverlayOpacity", "[OverlayOpacity] >= 0 AND [OverlayOpacity] <= 1");
                        });
                });
            ...
            modelBuilder.Entity("VentureHerdManager.Api.Models.CalvingEvent", b =>
                {
                    ...
                    b.ToTable("CalvingEvents", t =>
                        {
                            t.HasCheckConstraint("CK_CalvingEvents_NumberOfCalves", "[NumberOfCalves] >= 1");
                        });
                });
            ...
            modelBuilder.Entity("VentureHerdManager.Api.Models.ClassificationRecord", b =>
                {
                    ...
                    b.ToTable("ClassificationRecords", t =>
                        {
                            t.HasCheckConstraint("CK_ClassificationRecords_AgeInMonths", "[AgeInMonthsAtScoring] >= 0");

                            t.HasCheckConstraint("CK_ClassificationRecords_Score", "[Score] >= 0");
                        });
                });
