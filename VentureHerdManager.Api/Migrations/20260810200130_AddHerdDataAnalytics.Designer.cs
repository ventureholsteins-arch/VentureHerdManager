...
namespace VentureHerdManager.Api.Migrations
{
    ...
    [Migration("20260810200130_AddHerdDataAnalytics")]
    partial class AddHerdDataAnalytics
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VentureHerdManager.Api.Models.AnimalDataRecord", b =>
                {
                    b.Property<int>("AnimalDataRecordId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AnimalDataRecordId"));
                    ...
                    b.Property<int>("HerdDataImportId")
                        .HasColumnType("int");

                    b.Property<DateOnly?>("LastCalvingDate")
                        .HasColumnType("date");
                    ...
                    b.Property<string>("SourceAnimalId")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("SourceAnimalName")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.HasKey("AnimalDataRecordId");

                    b.HasIndex("HerdDataImportId");

                    b.HasIndex("AnimalId", "Source", "ReportDate");

                    b.ToTable("AnimalDataRecords");
                });

            modelBuilder.Entity("VentureHerdManager.Api.Models.AnimalIdentityMapping", b =>
                {
                    b.Property<int>("AnimalIdentityMappingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AnimalIdentityMappingId"));
                    ...
                    b.HasKey("AnimalIdentityMappingId");
                    ...
                    b.ToTable("AnimalIdentityMappings");
                });
            ...
            modelBuilder.Entity("VentureHerdManager.Api.Models.HerdDataImport", b =>
                {
                    b.Property<int>("HerdDataImportId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("HerdDataImportId"));
                    ...
                    b.HasKey("HerdDataImportId");

                    b.HasIndex("FileHash")
                        .IsUnique();

                    b.HasIndex("Source", "ReportDate");

                    b.ToTable("HerdDataImports");
                });
            ...
            modelBuilder.Entity("VentureHerdManager.Api.Models.AnimalDataRecord", b =>
                {
                    ...
                    b.HasOne("VentureHerdManager.Api.Models.HerdDataImport", "Import")
                        .WithMany("Records")
                        .HasForeignKey("HerdDataImportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
