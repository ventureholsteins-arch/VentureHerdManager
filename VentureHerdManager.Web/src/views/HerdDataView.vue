...
const genomicTraitCards = computed(() => [
  ...
  { key: 'typeScore', label: 'Type' }, { key: 'udderComposite', label: 'Udder' }, { key: 'feetLegsComposite', label: 'Feet & Legs' }
...
@media(max-width:700px){.ranking-grid,.genomic-score-strip{grid-template-columns:1fr}.trait-card-grid{grid-template-columns:repeat(2,1fr)}.trend-grid{grid-template-columns:repeat(2,1fr)}.cow-page-audit>div{grid-template-columns:1fr 1fr}}
</style>
