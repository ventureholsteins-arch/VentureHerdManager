...
type AnalyticsView = 'milk' | 'genomics' | 'linear' | 'combined' | 'imports'
const activeView = ref<AnalyticsView>((['milk', 'genomics', 'linear', 'combined', 'imports'].includes(String(route.query.view)) ? route.query.view : 'milk') as AnalyticsView)
